...
const TabSelect = () => {
  return (
    <div className="grid grid-cols-4 gap-x-16 cursor-pointer">
      {ListTabSelect &&
        ListTabSelect.length > 0 &&
        ListTabSelect.map((item) => (
          <div className="bg-[#fff] shadow-[0px_0px_27px_rgba(0,0,0,0.05)] w-[235px] flex items-center flex-col py-[23px] gap-y-1 rounded-[10px]">
