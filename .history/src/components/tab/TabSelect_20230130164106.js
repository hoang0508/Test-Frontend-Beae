        ...
        ListTabSelect.map((item) => (
          <div key={item.id}>
            {selectTab === item.id ? (
              ...
              >
                <div
                  className="bg-[#fff] shadow-[0px_0px_27px_rgba(0,0,0,0.05)] w-[235px] flex items-center flex-col lg:py-[23px] gap-y-1 rounded-[10px] max-sm:w-full max-sm:flex-row max-sm:pl-[30px]"
